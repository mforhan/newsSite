...
p {
 ...
 <body>
  <h4 style="font:xx-small;text-transform:uppercase">Monday, September 20, 2004</h4>
  <h2 style="font:x-large/1.5em Georgia,Verdana,Arial,Sans-serif;text-transform:uppercase;margin:2px;">Science says, "Water is wet"</h2>
  <h3 style="font:Georgia,Verdana,Arial,Sans-serif;margin:0px;"><i>Shocked residents protest study</i></h3>
  <p style="font:small;">
   by Betsy Steele<br/>
   Staff Reporter
  </p>
  ...
  <table cols=1 rows=2 style="width:250px;float:right;border-bottom:1px solid;">
   <tr><td><img src="images/raindrops.jpg" width="250"></td></tr>
   <tr><td>
    <p style="font-size:0.75em;color:#aaa;text-align:right;margin-bottom:5px;">submitted by NIH</p>
   <p style="font:xx-small;text-transform:uppercase;margin:5px;">
    After years of careful studies, the National Institute of Science issued a statement to the press today, declaring that water WAS indeed wet.
   </p>
    </td></tr>
  </table>
...
The German government reportedly plans to allot 26 million Euros for the station's replacement, Neumayer III.

<h3>A new icehouse</h3>

ESA's original designs for a SpaceHouse-based Neumayer III call for a tough outer shell of extremely lightweight carbon fiber reinforced plastic (CFRP), used in spacecraft solar arrays and antennas, as opposed to the traditional steel or aluminum. 
  <p/>
...
"You are just not bound by fixed walls," Gampe said. "So in principle it's an open area where you can make yourself happy."
  ...
  <table cols=1 rows=2 style="width:250px;float:left;border-bottom:1px solid;">
   <tr><td><img src="images/dunes.jpg" width="250"></td></tr>
   <tr><td>
    <p style="font-size:0.75em;color:#aaa;text-align:right;margin-bottom:5px;">submitted by NIH</p>
   <p style="font:xx-small;text-transform:uppercase;margin:5px;">
    During their studies, the institute found that items that did not contain water were "dry" 
   </p>
    </td></tr>
  </table>

<h3>Honing designs</h3>
