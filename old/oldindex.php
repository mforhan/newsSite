<?php
 ...
 $npage = "1";
 if($HTTP_GET_VARS) {
   $article_date = $HTTP_GET_VARS['articleDate'];
   // $article_id = $HTTP_GET_VARS['articleID'];
   // print "<h3>[$article_id]</h3>";
 }
?>
<html>
 <head>
...
<?// $content = retrieve_content($npage,1,'FULL',$article_id);
   $content = retrieve_content($npage,1,'FULL',$article_date);
...
<? } ?>
 ...
 <!--[<a href="rivercom_proposal.pdf">Rivercom Refund Proposal</a>]-->
