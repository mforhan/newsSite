...
//posting to yahoo finance
//echo SendToHost("www.reuters.com", "GET", "/financeQuoteLookup.jhtml", "qtype=sym&qcat=sbox&infotype=info&ticker=MSFT&x=20&y=2");
//echo SendToHost("finance.yahoo.com", "GET", "/d/quotes.csv", "s=MSFT,YHOO&f=sl1d1t1c1ohgv&e=.csv");
echo SendToHost("www.google.com", "GET", "/search", "hl=en&ie=UTF-8&oe=UTF-8&q=java");
//echo SendToHost("finance.yahoo.com", "GET", "/l", "s=M&t=S&m=US");


//$rows = SendToHost("finance.yahoo.com", "GET", "/d/quotes.csv", "s=" . $_GET[s] . "&f=sl1d1t1c1ohgv&e=.csv");
/*
$rows = SendToHost("finance.yahoo.com", "GET", "/d/quotes.csv", "s=" . "MSFT" . "&f=sl1d1t1c1ohgv&e=.csv");
