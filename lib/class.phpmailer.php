...
class phpmailer
{
     ...
     * Default is empty ("").
     * @public
     * @type string Such as "/home/asmlabs/www/pdf/lib/";
     */
	 
//    var $PluginDir         = "/home/asmlabs/www/thegame/lib/";
    ...
    function smtp_send($header, $body) {
        global $DOCUMENT_ROOT;
		  	$PluginDir = $DOCUMENT_ROOT . "/thegame/lib/";

        // Include SMTP class code, but not twice
        include_once($PluginDir . "class.smtp.php");
